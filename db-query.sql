...
-- test values
insert Student_Personal
values(101, 'amir', '2022-01-01', 21, 'jalan', 'perak', 'malaysia', 31350, '01251312617', 'amir1@gmail.com')
insert Student_Marks
values(102, 98, 45, 12, 65, 44, 74, 45, 101, 45.5, 'PASS', 'C')
...
FROM 'C:\Users\Amir Yusoff\Documents\GitHub\Python\python-training-miniproject\data\name-list.csv'
WITH
(
        FORMAT='CSV',
        FIRSTROW=2
...
FROM 'C:\Users\Amir Yusoff\Documents\GitHub\Python\python-training-miniproject\data\marks-list.csv'
WITH
(
        FORMAT='CSV',
        FIRSTROW=2
